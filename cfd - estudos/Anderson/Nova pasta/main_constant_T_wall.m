...
% https://www.mathworks.com/matlabcentral/fileexchange/49155-numerical-solution-of-the-supersonic-flow-over-a-flat-plate
...
% Grid size %
%%%%%%%%%%%%%
IMAX = 6; % Number of grid points along the x-coordinate
JMAX = 6; % Number of grid points along the y-coordinate
...
%%%%%%%%%%%%%%%%%%%%%%%%
T_w_T_inf = 1; % Ratio of wall temperature to freestream temperature (for the constant-temperature
...
T(1,:) = T_w_T_inf*T_inf; % At the surface, the wall temperature is enforced (for the constant-temperature
% wall boundary condition case)
